    ...
    return (
        <>
            ...
            <Section id="sign-up-process" title="Sign-Up Process">
                <Text fontSize={{base: "xl", mdDown:"md"}}>To sign up, click the <Link href="/join" variant={"underline"}>"Become a Member"</Link> button to purchase your preferred membership term.  Next, complete our <Link href="/assets/membership_form.pdf" variant={"underline"}>membership form</Link> and email it to <Link href="mailto:membership@metamakers.org" variant={"underline"}>membership@metamakers.org</Link>. We'll respond via email to schedule an orientation.  At the orientation, you'll need to review and accept our <Link href="/assets/sop.pdf" variant={"underline"}>standard operating procedures (SOPs)</Link> and sign our <Link href="/assets/waiver.pdf" variant={"underline"}>liability waiver</Link>. Finally, we'll provide a tour of the makerspace and issue your keycard.</Text>
            </Section>
